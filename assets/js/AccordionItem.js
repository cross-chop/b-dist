import { c as createComponent, d as createAstro, m as maybeRenderHead, e as addAttribute, a as renderTemplate, b as renderScript, r as renderComponent, f as renderSlot, u as unescapeHTML } from './astro/server.js';
import 'kleur/colors';
import 'clsx';
/* empty css        */
...
const $$Lineup = createComponent(($$result, $$props, $$slots) => {
  ...
  const lineupData = ["bio-three-hi", "new-withone", "colac-ii", "borraginol-a", "daichi-no-kampo"].filter(
...
${renderComponent($$result, "lineup-component", "lineup-component", { "data-astro-cid-cniar3gg": true }, { "default": () => renderTemplate`
  ${maybeRenderHead()}<div class="Lineup" data-scrollTo="lineup" data-astro-cid-cniar3gg>
    ...
    ${!exclude.includes("mgo") && renderTemplate`<div class="inHouseProduct" data-astro-cid-cniar3gg>
          ${renderComponent($$result, "ProductItem", $$ProductItem, { "id": "mgo", "order": true, "isBigCartBtn": true, "data-astro-cid-cniar3gg": true })}
        </div>`}
...
const $$Accordion = createComponent(async ($$result, $$props, $$slots) => {
  return renderTemplate`${renderScript($$result, "/Users/bofft/Works/bebo/src/components/Accordion.astro?astro&type=script&index=0&lang.ts")}

${renderComponent($$result, "accordion-component", "accordion-component", { "data-astro-cid-oqjbs5yv": true }, { "default": () => renderTemplate`
  ${maybeRenderHead()}<div class="Accordion" data-astro-cid-oqjbs5yv>
    ${renderSlot($$result, $$slots["default"])}
  </div>
` })}`;
}, "/Users/bofft/Works/bebo/src/components/Accordion.astro", void 0);
...
const $$AccordionItem = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="accordionItem" data-astro-cid-3p7czjhg>
  <h3 class="question" data-astro-cid-3p7czjhg>
    <span data-astro-cid-3p7czjhg>${unescapeHTML(question)}</span>
    <div class="arrow" data-astro-cid-3p7czjhg>
      <svg viewBox="0 0 13 8" fill="none" data-astro-cid-3p7czjhg>
        <path d="M12 1.19897L6.5 6.69897L1 1.19897" stroke="black" stroke-width="1.375" stroke-linecap="square" data-astro-cid-3p7czjhg></path>
      </svg>
    </div>
  </h3>
  <div class="answer" data-astro-cid-3p7czjhg>
    <div class="inner" data-astro-cid-3p7czjhg>
      ${renderSlot($$result, $$slots["default"])}
    </div>
  </div>
</div>`;
}, "/Users/bofft/Works/bebo/src/components/AccordionItem.astro", void 0);

export { $$Accordion as $, $$AccordionItem as a, $$Lineup as b, $$SectionHeader as c };
