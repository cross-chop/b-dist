...
const $$ResultDiagnosis = createComponent(($$result, $$props, $$slots) => {
  ...
  const summaryData = {
    ...
    "warning-symptoms": '\u3042\u306A\u305F\u306E\u56DE\u7B54\u304B\u3089\u3001<br class="sp" /><span class="type">\u901A\u5E38\u306E\u4FBF\u79D8\u3068\u306F\u7570\u306A\u308B<br />\u6CE8\u610F\u304C\u5FC5\u8981\u306A\u75C7\u72B6</span>\u304C<br class="sp" />\u898B\u3089\u308C\u307E\u3057\u305F\u3002',
    // '現在、あなたには<br /><span class="type">便秘の傾向は<br class="sp" />あまり見られません</span>。',
